...
import { LayoutDashboard, CheckCircle, Loader, ChevronRight, Menu, X, Scissors } from 'lucide-react';
...
const BarberLayout: React.FC = () => {
    ...
    const navItems = [
        ...
        { name: 'Validar Encomenda', path: '/barbeiro/verificar-encomenda', icon: CheckCircle },
    ];
                ...
                {(sidebarOpen || window.innerWidth >= 1024) && (
                    ...
                    >
                        ...
                        <div className="lg:hidden p-6 flex justify-between items-center border-b border-white/5 bg-zinc-900/50">
                            <span className="font-heading font-bold text-white text-lg">Menu Barbeiro</span>
                        ...
                        <div className="p-6">
                            <h2 className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-6 hidden lg:block">Painel do Barbeiro</h2>
                        ...
                        <div className="absolute bottom-0 w-full p-6 bg-gradient-to-t from-black/80 to-transparent lg:from-black/50">
                            <div className="flex items-center gap-3 p-3 rounded-lg bg-white/5 border border-white/5">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-white truncate max-w-[120px]">{user?.user_metadata?.nome || 'Barbeiro'}</p>
                                </div>
                            </div>
                        </div>
                    </motion.aside>
